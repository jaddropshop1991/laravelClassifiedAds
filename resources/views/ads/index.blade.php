 ...
 <div class="container">
  ...
  @forelse ($ads as $key=>$ad)
    ...
    <tr>
      ...
      <td style="width: 200px; heigth:130px">
        ...
        <div id="carouselExampleControls{{ $ad->id }}" class="carousel slide" data-ride="carousel">
          <div class="carousel-inner">
            <div class="carousel-item active">
              {{-- <img src="{{ Storage::url($ad->featured_image) }}" width="130"alt=""> --}}
              <img src="{{ $ad->featured_image }}" width="130"alt="">

            </div>
            <div class="carousel-item">
              {{-- <img src="{{ Storage::url($ad->first_image) }}" width="130"alt=""> --}}
              <img src="{{ $ad->first_image }}" width="130"alt="">

            </div>
            <div class="carousel-item">
              {{-- <img src="{{ Storage::url($ad->second_image) }}" width="130"alt=""> --}}
              <img src="{{ $ad->second_image }}" width="130"alt="">
      ...
      <td>
        <a href="{{ route('ads.edit', $ad->id) }}"><button class="btn btn-primary">Edit</button></a></td>
      <td>
